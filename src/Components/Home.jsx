...
const Home = () => {
  return (
    <div id="home" className="mt-20 flex md:h-[calc(86vh-4rem)] flex-col gap-6 items-center text-center md:flex-row lg:justify-between lg:text-left ">
      <div className="font-mono flex-1">
        ...
        <h1 className="text-sm text-gray-500 mb-4 font-semibold">
