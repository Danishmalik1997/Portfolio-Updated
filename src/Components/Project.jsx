  ...
  return (
    <div id="project" className="p-10 md:p-20">
      ...
      md:flex-row md:gap-3 mb-20 overflow-hidden md:overflow-visible md:p-5"  style={{ opacity: 1 }} >
        ...
        md:w-2.5/3 lg:w1/2 z-10 md:bg-transparent md:mt-5"
          >
        ...
        <div
          className="m-2 rounded-md md:absolute md:w-1/2 top-0 md:top-auto 
      ...
      >
        ...
        md:w-2.5/3 lg:w1/2 z-10 md:bg-transparent md:mt-5"
          >
            ...
            <p className="text-slate-600">
              This is Pizza Burger delivery application provides a platform where
              users can order their meal and track their order status.
              It combines a user-friendly interactivity where user can select the
              category according to their personal like. This web-App have nice user-interface, 
              ui/ux design and front-end functionality. 
            </p>
            <div className="font-mono mt-4 font-bold flex flex-wrap gap-x-8 gap-y-4 text-sm">
              <span>JavaScript</span>
              <span>React</span>
